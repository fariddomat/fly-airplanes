                ...
                <form class="car-search-form" id="carSearchForm" action="{{ route('cars.search') }}" method="POST">
                    ...
                    <div class="rental-type-section">
                        <div class="rental-type-options">
                            <label class="rental-type-option">
                                <input type="radio" name="rentalType" value="same-location"
                                    {{ old('rentalType', 'same-location') == 'same-location' ? 'checked' : '' }}>
                                <span class="option-text">نفس موقع الاستلام والتسليم</span>
                            </label>
                            <label class="rental-type-option">
                                <input type="radio" name="rentalType" value="different-location"
                                    {{ old('rentalType') == 'different-location' ? 'checked' : '' }}>
                                ...
                                <select id="pickupLocation" name="pickupLocation" class="form-input" required>
                                    ...
                                    @foreach ($airports as $airport)
                                        <option value="{{ $airport->city }}"
                                            {{ old('pickupLocation') == $airport->city ? 'selected' : '' }}>
                                            {{ $airport->name }} - {{ $airport->city }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="popular-locations">
                                ...
                                @foreach ($airports->take(3) as $airport)
                                    <button type="button" class="location-chip"
                                        onclick="setLocation('pickupLocation', '{{ $airport->city }}')">{{ $airport->city }}</button>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="form-group location-group" id="dropoffLocationGroup" style="display: none;">
                            ...
                            <div class="input-wrapper">
                                <select id="dropoffLocation" name="dropoffLocation" class="form-input">
                                    ...
                                    @foreach ($airports as $airport)
                                        <option value="{{ $airport->city }}"
                                            {{ old('dropoffLocation') == $airport->city ? 'selected' : '' }}>
                                            {{ $airport->name }} - {{ $airport->city }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="popular-locations">
                                ...
                                @foreach ($airports->take(3) as $airport)
                                    <button type="button" class="location-chip"
                                        onclick="setLocation('dropoffLocation', '{{ $airport->city }}')">{{ $airport->city }}</button>
                                @endforeach
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="date" id="pickupDate" name="pickupDate"
                                        class="form-input date-input" value="{{ old('pickupDate') }}" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <select id="pickupTime" name="pickupTime" class="form-input" required>
                                        @foreach (['09:00' => '09:00 صباحاً', '10:00' => '10:00 صباحاً', '11:00' => '11:00 صباحاً', '12:00' => '12:00 ظهراً', '13:00' => '01:00 ظهراً', '14:00' => '02:00 ظهراً', '15:00' => '03:00 عصراً', '16:00' => '04:00 عصراً', '17:00' => '05:00 عصراً', '18:00' => '06:00 مساءً', '19:00' => '07:00 مساءً', '20:00' => '08:00 مساءً'] as $value => $label)
                                            <option value="{{ $value }}"
                                                {{ old('pickupTime') == $value ? 'selected' : '' }}>{{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <input type="date" id="dropoffDate" name="dropoffDate"
                                        class="form-input date-input" value="{{ old('dropoffDate') }}" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    <select id="dropoffTime" name="dropoffTime" class="form-input" required>
                                        @foreach (['09:00' => '09:00 صباحاً', '10:00' => '10:00 صباحاً', '11:00' => '11:00 صباحاً', '12:00' => '12:00 ظهراً', '13:00' => '01:00 ظهراً', '14:00' => '02:00 ظهراً', '15:00' => '03:00 عصراً', '16:00' => '04:00 عصراً', '17:00' => '05:00 عصراً', '18:00' => '06:00 مساءً', '19:00' => '07:00 مساءً', '20:00' => '08:00 مساءً'] as $value => $label)
                                            <option value="{{ $value }}"
                                                {{ old('dropoffTime') == $value ? 'selected' : '' }}>{{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="form-group">
                            <label for="carType" class="form-label">
                                <svg class="label-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2">
                                    <path
                                        d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9L18.4 10c-.4-.8-1.2-1.3-2.1-1.3H7.7c-.9 0-1.7.5-2.1 1.3l-2.1 1.1C2.7 11.3 2 12.1 2 13v3c0 .6.4 1 1 1h2" />
                            ...
                            <div class="input-wrapper">
                                <select id="carType" name="carType" class="form-input">
                                    ...
                                    @foreach (['economy' => 'اقتصادية', 'compact' => 'مدمجة', 'sedan' => 'سيدان', 'suv' => 'دفع رباعي (SUV)', 'luxury' => 'فاخرة', 'van' => 'فان عائلي', 'convertible' => 'مكشوفة'] as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ old('carType') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="input-wrapper">
                                <select id="transmission" name="transmission" class="form-input">
                                    ...
                                    <option value="automatic" {{ old('transmission') == 'automatic' ? 'selected' : '' }}>
                                        أوتوماتيك</option>
                                    <option value="manual" {{ old('transmission') == 'manual' ? 'selected' : '' }}>يدوي
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <select id="fuelType" name="fuelType" class="form-input">
                                    <option value="">جميع الأنواع</option>
                                    <option value="petrol" {{ old('fuelType') == 'petrol' ? 'selected' : '' }}>بنزين
                                    </option>
                                    <option value="diesel" {{ old('fuelType') == 'diesel' ? 'selected' : '' }}>ديزل
                                    </option>
                                    <option value="hybrid" {{ old('fuelType') == 'hybrid' ? 'selected' : '' }}>هجين
                                    </option>
                                    <option value="electric" {{ old('fuelType') == 'electric' ? 'selected' : '' }}>كهربائي
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <select id="driverAge" name="driverAge" class="form-input" required>
                                    ...
                                    <option value="21-24" {{ old('driverAge') == '21-24' ? 'selected' : '' }}>21-24 سنة
                                    </option>
                                    <option value="25-29" {{ old('driverAge') == '25-29' ? 'selected' : '' }}>25-29 سنة
                                    </option>
                                    <option value="30-64" {{ old('driverAge') == '30-64' ? 'selected' : '' }}>30-64 سنة
                                    </option>
                                    <option value="65+" {{ old('driverAge') == '65+' ? 'selected' : '' }}>65+ سنة
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="additional-options">
                        ...
                        <div class="options-grid">
                            ...
                            <label class="option-checkbox">
                                <input type="checkbox" name="childSeat" value="1"
                                    {{ old('childSeat') ? 'checked' : '' }}>
                                <span class="checkmark"></span>
                                <div class="option-info">
                            ...
                            <label class="option-checkbox">
                                <input type="checkbox" name="additionalDriver" value="1"
                                    {{ old('additionalDriver') ? 'checked' : '' }}>
                                <span class="checkmark"></span>
                                <div class="option-info">
    ...
    <script>
        ...
        document.querySelectorAll('input[name="rentalType"]').forEach(radio => {
            radio.addEventListener('change', function() {
                document.getElementById('dropoffLocationGroup').style.display = this.value ===
                    'different-location' ? 'block' : 'none';
            });
        });
    </script>
@endsection
